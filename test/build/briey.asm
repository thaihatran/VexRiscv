...
80000068:	2b0080e7          	jalr	688(ra) # 40000314 <irqCallback>
  lw x1 , 15*4(sp)
...
800000b8:	b8c18193          	addi	gp,gp,-1140 # 40000c40 <__global_pointer$>
  .option pop
  la sp, _stack_start
...
800000c8:	37c50513          	addi	a0,a0,892 # 40000440 <_bss_end>
  la a1, _bss_end
800000cc:	c0000597          	auipc	a1,0xc0000
800000d0:	37458593          	addi	a1,a1,884 # 40000440 <_bss_end>
...
800000e8:	35c50513          	addi	a0,a0,860 # 40000440 <_bss_end>
  addi sp,sp,-4
...
800000f4:	35058593          	addi	a1,a1,848 # 40000440 <_bss_end>
...
int main() {
40000294:	fe010113          	addi	sp,sp,-32
40000298:	00112e23          	sw	ra,28(sp)
4000029c:	00812c23          	sw	s0,24(sp)
400002a0:	02010413          	addi	s0,sp,32
	Uart_Config uartConfig;
	uartConfig.dataLength = 8;
400002a4:	00800793          	li	a5,8
400002a8:	fef42023          	sw	a5,-32(s0)
	uartConfig.parity = NONE;
400002ac:	fe042223          	sw	zero,-28(s0)
	uartConfig.stop = ONE;
400002b0:	fe042423          	sw	zero,-24(s0)
	uartConfig.clockDivider = (CORE_HZ / 8 / 115200) - 1;
400002b4:	03500793          	li	a5,53
400002b8:	fef42623          	sw	a5,-20(s0)
	uart_applyConfig(UART,&uartConfig);
400002bc:	fe040793          	addi	a5,s0,-32
...
400002d0:	39078513          	addi	a0,a5,912 # 40000390 <vga_simRes_h160_v120+0x20>
400002d4:	f69ff0ef          	jal	ra,4000023c <print>
	print("University of Electro-Communications (UEC), Tokyo, Japan\r\n");
400002d8:	400007b7          	lui	a5,0x40000
400002dc:	3bc78513          	addi	a0,a5,956 # 400003bc <vga_simRes_h160_v120+0x4c>
400002e0:	f5dff0ef          	jal	ra,4000023c <print>
	print("電気通信大学、東京都、日本\r\n");
400002e4:	400007b7          	lui	a5,0x40000
400002e8:	3f878513          	addi	a0,a5,1016 # 400003f8 <vga_simRes_h160_v120+0x88>
400002ec:	f51ff0ef          	jal	ra,4000023c <print>
	print("PHAM LAB ! 範研究室 !\r\n");
400002f0:	400007b7          	lui	a5,0x40000
400002f4:	42478513          	addi	a0,a5,1060 # 40000424 <vga_simRes_h160_v120+0xb4>
400002f8:	f45ff0ef          	jal	ra,4000023c <print>
400002fc:	00000793          	li	a5,0
}
40000300:	00078513          	mv	a0,a5
40000304:	01c12083          	lw	ra,28(sp)
40000308:	01812403          	lw	s0,24(sp)
4000030c:	02010113          	addi	sp,sp,32
40000310:	00008067          	ret

40000314 <irqCallback>:


void irqCallback(){
40000314:	ff010113          	addi	sp,sp,-16
40000318:	00812623          	sw	s0,12(sp)
4000031c:	01010413          	addi	s0,sp,16
